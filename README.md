...
- **Static**: the completion parses and compiles, matches the declared control-flow graph, and draws each constant from the constant table at exactly its listed live and dead counts (`1` and `1.0` count as distinct).
